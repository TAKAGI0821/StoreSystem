...
public class S1_C extends javax.swing.JDialog {

    /**
     * Creates new form S1_C
     */
    private Seat1_JF main = null;
    StringBuilder pass = new StringBuilder();
    Socket soc;

    public S1_C(java.awt.Frame parent, boolean modal, Socket sct) {
        super(parent, modal);
        initComponents();
        soc = sct;
    }

    public void Seat1_JF_setFrame(Seat1_JF m) {
        this.main = m;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S1_C.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
